...
namespace Back_End_Final_Education.Migrations
{
    ...
    [Migration("20240607084250_CreateAboutTable")]
            ...
            modelBuilder.Entity("Back_End_Final_Education.Models.About", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 6, 7, 12, 42, 50, 491, DateTimeKind.Local).AddTicks(8890),
            ...
            modelBuilder.Entity("Back_End_Final_Education.Models.Icon", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 6, 7, 12, 42, 50, 491, DateTimeKind.Local).AddTicks(8850),
                            SoftDeleted = false
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 6, 7, 12, 42, 50, 491, DateTimeKind.Local).AddTicks(8860),
                            SoftDeleted = false
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Back_End_Final_Education.Models.Information", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 6, 7, 12, 42, 50, 491, DateTimeKind.Local).AddTicks(8870),
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2024, 6, 7, 12, 42, 50, 491, DateTimeKind.Local).AddTicks(8880),
                            Description = "Diam elitr kasd sed at elitr sed ipsum justo dolor sed clita amet diam",
                            IconId = 3,
                            SoftDeleted = false,
                            Title = "Home Projects"
            ...
            modelBuilder.Entity("Back_End_Final_Education.Models.Slider", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 6, 7, 12, 42, 50, 491, DateTimeKind.Local).AddTicks(8770),
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 6, 7, 12, 42, 50, 491, DateTimeKind.Local).AddTicks(8780),
                            Description = "Vero elitr justo clita lorem. Ipsum dolor at sed stet sit diam no. Kasd rebum ipsum et diam justo clita et kasd rebum sea sanctus eirmod elitr.",
